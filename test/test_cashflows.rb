...
describe "Cashflows" do
  ...
  describe "an array of Transactions" do
    ...
    it "should properly calculate IRR when Complex numbers arise from calculations" do
      arr = [ Finance::Transaction.new( 70, :date => Time.new(2015,7,31)),
              Finance::Transaction.new(-90, :date => Time.new(2021,1,13)),
              Finance::Transaction.new(-20, :date => Time.new(2021,3,31)) ]
    ...
    it "IRR should decrease as payback moves further and further into the future" do
      ...
      (1..30).each do |n|
        arr = [ Finance::Transaction.new(100, :date => Time.new(2001,1,1)),
                Finance::Transaction.new(-50, :date => Time.new(2001,2,1)),
                Finance::Transaction.new(-60, :date => Time.new(2001,2,1) + n * 30*24*3600) ]
